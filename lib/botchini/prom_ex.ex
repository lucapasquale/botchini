defmodule Botchini.PromEx do
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      {Plugins.Phoenix, router: BotchiniWeb.Router, endpoint: BotchiniWeb.Endpoint},
      Plugins.Ecto
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:botchini, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
